...
namespace HospitalSystem2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            }).AddEntityFrameworkStores<AppDbContext>().AddTokenProvider<DataProtectorTokenProvider<AppUser>>
            (TokenOptions.DefaultProvider).AddEntityFrameworkStores<AppDbContext>();
